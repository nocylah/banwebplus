...
class icalendarFunctions {
	...
	public static function calendarLinkToString($s_linktype) {
		...
		if ($s_linktype == "web")
				return "http://www.beanweb.plus/pages/icalendar/calendars/{$s_username}/".$a_settings_rows[0]['private_icalendar_key']."/ClassSchedule.ics";
		else if ($s_linktype == "view")
				return "http://www.beanweb.plus/pages/icalendar/calendars/{$s_username}/".$a_settings_rows[0]['private_icalendar_key']."/pretty/ClassSchedule.ics";
		else if ($s_linktype == "download")
				return "http://www.beanweb.plus/pages/icalendar/calendars/{$s_username}/".$a_settings_rows[0]['private_icalendar_key']."/download/ClassSchedule.ics";
		else
...
CALSCALE:GREGORIAN
METHOD:PUBLISH
X-WR-CALNAME:{$s_username}@beanweb.plus
